...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <?php echo Form::open(['route' => 'accountant.store', 'class' => 'horizontal-form', 'role' => 'form', 'method' => 'post']); ?>
              ...
              <table class="table table-striped table-bordered table-hover" id="datatable-ajax">
                <thead>
                  ...
                  <tr role="row" class="filter">
                    <td width="10%">
                      <?php /* Form::hidden('customer_id', Session::get('customer_id'), ['id' => 'customer_id']) */ ?>
                      <?php /* Form::text('customer_name', Session::has('customer_name') ? Session::get('customer_name') : null , ['class' => 'form-control form-filter input-sm', 'id' => 'customer_name', 'autocomplete' => 'off']) */ ?>
                      <?php if(Session::has('customer_id')): ?>
                        <input type="hidden" name="customer_id" value="<?php echo e(Session::get('customer_id')); ?>" class="form-control form-filter input-sm" id="customer_id" autocomplete="off">
                      <?php else: ?>
                      ...
                      <?php if(Session::has('customer_name')): ?>
                        <input type="text" name="customer_name" value="<?php echo e(Session::get('customer_name')); ?>" class="form-control form-filter input-sm" id="customer_name" autocomplete="off">
                      <?php else: ?>
                      <input type="text" name="customer_name" value="" class="form-control form-filter input-sm" id="customer_name" autocomplete="off">
                      <?php endif; ?>
                    </td>
                    <td width="40%">
                      <?php echo Form::hidden('itemid', null, ['id' => 'item-id']); ?>

                      <?php echo Form::text('name', null, ['class' => 'form-control form-filter input-sm', 'id' => 'item-name', 'autocomplete' => 'off']); ?>

                    </td>
                    <td width="10%">
                      <?php echo Form::text('qty', null, ['class' => 'form-control form-filter input-sm', 'id' => 'qty', 'onkeyup' => 'sub_total()']); ?>

                    </td>
                    <td width="10%">
                      <?php echo Form::text('price', null, ['class' => 'form-control form-filter input-sm', 'id' => 'price', 'readonly' => '1']); ?>

                    </td>
                    <td width="10%">
                      <?php echo Form::text('amount', null, ['class' => 'form-control form-filter input-sm', 'id' => 'amount', 'readonly' => '1']); ?>

                    </td>
                    <td width="5%" style="text-align:center;">
                      <?php echo Form::button('Add', ['class' => 'btn btn-primary btn-sm add', 'name' => 'action']); ?>
              ...
              <table class="table table-striped table-bordered table-hover" id="table">
                ...
                <tbody id="item-list" name="item-list">
                  <?php if(Session::has('items')): ?>
                    <?php foreach(Session::get('items') as $item): ?>
                    <tr id="item<?php echo e($item['id']); ?>">
                      ...
                      <td style="text-align:right;" class="amount"><?php echo e($item['amount']); ?></td>
                      <td style="text-align:center;">
                        <?php /*
                        <a href="<?php echo e(url('transactions/deleteitem', $item['id'])); ?>" onclick="deleteitem(<?php echo e($item['id']); ?>)" class="btn btn-xs btn-danger">
                          <i class="fa fa-trash"></i>  Delete
                        </a>
                        */ ?>

                        <a href="#" onclick="deleteitem(<?php echo e($item['id']); ?>, '<?php echo e($item['name']); ?>')" class="btn btn-xs btn-danger">
                          <i class="fa fa-trash"></i>  Delete
                        </a>
...
<?php $__env->startSection('autocomplete'); ?>
...
function deleteitem(id, name)
{
  ...
  var deleteUrl = "<?php echo e(route('accountant.deleteitem', ':id')); ?>";
...
function clearitems()
{
  ...
  if(confirm('Yakin ingin hapus transaksi ini?'))
  {
    ...
    $.ajax({
      url : "<?php echo e(route('accountant.clearitems')); ?>",
      type : "POST",
      dataType  : "JSON",
...
$( document ).ready(function() {
  ...
  $("#item-name").autocomplete({
    source: "<?php echo e(route('accountant.autocomplete')); ?>",
    minLength: 1,
  ...
  $("#customer_name").autocomplete({
    source: "<?php echo e(route('accountant.autocompleteCustomer')); ?>",
    minLength: 1,
    select: function (event, ui) {
  ...
  $(".pay").click(function (e){
    ...
    var url = "<?php echo e(route('accountant.store')); ?>";
