...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-warning">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <form role="form" action="{{ route('manager.materials.updatestock', $material->id) }}" method="POST">
              {{ csrf_field() }}
              <!-- text input -->
              <div class="form-group {{ $errors->has('name') ? 'has-error' : ''  }}">
                <label>Nama</label>
                <input class="form-control" placeholder="Sabun" name="name" type="text" value="{{ $material->name }}" disabled>
              ...
              <div class="form-group {{ $errors->has('stock') ? 'has-error' : ''  }}">
                ...
                <input class="form-control" placeholder="Jumlah stok yang ingin ditambahkan" name="quantity" type="text">
