          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">Semua Material</h3>
              ...
              <div class="box-body table-responsive no-padding">
                ...
                <table class="table table-hover">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('manager.materials.destroy', $material->id) }}" role="button" class="btn btn-danger">Delete</a>

                      <a href="{{ route('manager.materials.stock', $material->id) }}" role="button" class="btn btn-warning">Tambah Stock</a>
