...
<div class="panel panel-left panel-cover">
      <div class="user_login_info">
            ...
            <img src="mobix/images/profile.jpg" alt="" title="" />
              ...
              <nav class="user-nav">
                <ul>
                  <li><a href="{{ url('transactions') }}" class="close-panel"><i class="fa fa-users"></i>Semua Transaksi</a></li>
                  <li><a href="{{ url('antrianKasir')}}" class="close-panel"><i class="fa fa-user-plus"></i>Antrian</a></li>
