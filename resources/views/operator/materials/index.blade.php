              ...
              <div class="box-body table-responsive no-padding">
                ...
                <table class="table table-hover">
                  ...
                  <tr>
                    ...
                    {{--
                    <td>
                        @if($material->transaction_category == 1)
                          Income
                        @elseif($material->transaction_category == 2)
                          Outcome
                        @endif
                    </td>
                    --}}
                    <td>
                      <a href="{{ route('operator.materials.destroy', $material->id) }}" role="button" class="btn btn-danger">Delete</a>
                      {{--
