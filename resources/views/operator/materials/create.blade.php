...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-warning">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <form role="form" action="{{ route('operator.materials.store') }}" method="POST">
              {{ csrf_field() }}
              <!-- text input -->
              <div class="form-group {{ $errors->has('name') ? 'has-error' : ''  }}">
                <label>Nama</label>
                <input class="form-control" placeholder="Sabun" name="name" type="text">
              ...
              <div class="form-group {{ $errors->has('stocks') ? 'has-error' : ''  }}">
                <label>Jumlah</label>
                <input class="form-control" placeholder="10" name="quantity" type="text">
