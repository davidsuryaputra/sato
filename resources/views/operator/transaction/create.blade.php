...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    {!! Form::open(['route' => 'operator.store', 'class' => 'horizontal-form', 'role' => 'form', 'method' => 'post']) !!}
...
function deleteitem(id, name)
{
  ...
  var deleteUrl = "{{ route('operator.deleteitem', ':id') }}";
...
$( document ).ready(function() {
  ...
  $("#item-name").autocomplete({
    source: "{{ route('operator.autocomplete') }}",
    minLength: 1,
  ...
  $("#customer_name").autocomplete({
    source: "{{ route('operator.autocompleteCustomer') }}",
    minLength: 1,
    select: function (event, ui) {
