...
<ul class="sidebar-menu">
  ...
  <li class="treeview">
    <a href="#">
      <i class="fa fa-home"></i> <span>Terima Pelanggan</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
  ...
  <li class="treeview">
    <a href="#">
      <i class="fa fa-home"></i> <span>Antrian</span> <i class="fa fa-angle-left pull-right"></i>
    </a>
    {{--
    <ul class="treeview-menu">
      <li>
